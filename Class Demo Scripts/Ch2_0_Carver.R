...
#  Set working directory on your own computer
# need to modify next 2 lines of code.


setwd("C:/Users/Rob/Box Sync/My R Work/BUS212")
housing.df <- read.csv("C:/Users/Rob/Box Sync/My R Work/BUS212/Data/WestRoxbury.csv", header = TRUE)  # load data
...
# in textbook version, next line of code has a typo
# install.packages(dummies) ### TYPO-- no quotes
install.packages("dummies")
library(dummies)
housing2.df <- dummy.data.frame(housing.df, sep = ".")   # 2ND df
names(housing2.df)
