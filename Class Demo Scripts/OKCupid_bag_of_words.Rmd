...
test_idx <- sample.int(n, size= round(0.2 * n))  # sample 10% of rows
...
special <- c("san","francisco", "never", "now", "lot", "hang", "bit", "much", "ago","also","make","can","will", "dont", "tell", "still", "went", "find", "want", "look", "good", "guy", "ive", "see", "just", "thing")
...
wordcloud(words=names(wordFreq), freq=wordFreq, max.words=100,
