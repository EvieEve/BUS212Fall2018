## Shmueli chapter 11, with corrections
#### Table 11.2

library(neuralnet)
## note: original Shmueli script has an error in datafile name
df <- read.csv("Data/tinydata.csv")
...
#### Table 11.6, 11.7
library(nnet)  # this line is incorrect in original version

accidents.df <- read.csv("Data/Accidentsnn.csv")
# selected variables
